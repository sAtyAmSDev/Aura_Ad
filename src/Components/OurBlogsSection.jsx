      ...
      <div className="OurBlogs">
        ...
        <div className="BlogsCBox">
          <div className="BlogCard">
            <div className="Top">
              <div className="Status"  style={{ color: 'red', fontSize: '15px' }}>
                <FaCircle />
              </div>
          ...
          <div className="BlogCard">
            <div className="Top">
              <div className="Status" style={{ color: 'blue', fontSize: '15px' }} >
                <FaCircle  />
              </div>
              <p className="Time">5 min read</p>
            </div>
          ...
          <div className="BlogCard">
            <div className="Top">
              <div className="Status"  style={{ color: 'green', fontSize: '15px' }}>
                <FaCircle />
              </div>
              <p className="Time">5 min read</p>
            </div>
